...
[Pinia](https://nicelinks.site/redirect?url=https://pinia.vuejs.org/) （发音为 `/piːnjʌ/`，如英语中的“peenya”）是最接近 _piña_（西班牙语中的*菠萝*）的词，它是一个有效的包名称。菠萝实际上是一组单独的花朵，它们结合在一起形成多个水果。与商店类似，每一家都是独立诞生的，但最终都是相互联系的。它也是一种美味的热带水果，原产于南美洲。
