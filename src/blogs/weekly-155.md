...
## [StackShare - Tech Stack Intelligence](https://site.lovejade.cn/post/65bb80a68950812ce6932c83)

**标签**：[`分析`](https://site.lovejade.cn/tags/分析) · [`平台`](https://site.lovejade.cn/tags/平台) · [`技术`](https://site.lovejade.cn/tags/技术)
...
**推荐语**：[StackShare](https://stackshare.io/) 是一个提供技术栈智能 [分析](https://site.lovejade.cn/tags/分析) 的 [平台](https://site.lovejade.cn/tags/平台) ，旨在**帮助企业和技术团队更好地理解和管理他们的技术栈**。它通过提供实时的、数据驱动的洞察，帮助企业做出更明智的技术决策，优化 [技术](https://site.lovejade.cn/tags/技术) 治理，并提高开发效率。以下是 StackShare 的主要服务和特点：
...
2023 年 12 月 31 日，StackShare 汇总了超过 **100 万个技术堆栈**的使用情况 ，超过  **1000 万个关注者** ，以及更多的开发者评论、评论和投票，梳理大量数据集，在文章 [2023 年 100 多个最佳开发者工具](https://stackshare.io/posts/top-developer-tools-2023) 呈现出来；AI 工具放到了第一，诸如 [LangChain](https://site.lovejade.cn/post/65a92d572c315d2784ce66b9) 、 [Auto-GPT](https://site.lovejade.cn/post/6453ac5fc6f2367a83e8699f) 、 [Pinecone](https://site.lovejade.cn/post/659fdc6eae8b2b2d0a974cb2) 、Chroma 均有上榜，2024 年学习、折腾的方向，可见一斑。
...
── 出自[倾城之链 - StackShare - Tech Stack Intelligence](https://site.lovejade.cn/post/65bb80a68950812ce6932c83)

## [Wave Terminal | An open-source, cross-platform terminal for seamless workflows](https://site.lovejade.cn/post/65bb7f998950812ce6932c7e)

**标签**：[`终端`](https://site.lovejade.cn/tags/终端) · [`跨平台`](https://site.lovejade.cn/tags/跨平台) · [`开源`](https://site.lovejade.cn/tags/开源)
...
**推荐语**：[Wave Terminal](https://www.waveterm.dev/) 是一个 [开源](https://site.lovejade.cn/tags/开源) 的、 [跨平台](https://site.lovejade.cn/tags/跨平台) 的 [终端](https://site.lovejade.cn/tags/终端) 模拟器，它旨在为用户提供无缝的工作流程体验。它基于现代的 Web 技术构建，提供了一些创新的功能，以提高开发者的生产力。以下是 Wave Terminal 的一些主要特点和优势：

### 主要特点

1.  **AI 集成**：Wave Terminal 支持 AI 集成，这意味着它可以与各种 AI 工具和应用程序配合使用，以增强终端的功能。

2.  **内联渲染**：它允许用户在终端内直接渲染多种文件类型，如 [Markdown](https://site.lovejade.cn/tags/Markdown) 、CSV 和 JSON，而无需打开外部浏览器或编辑器。

3.  **图像预览**：Wave Terminal 支持在终端内预览图片，如 .jpeg、.png、.gif 等，提供了更加丰富的视觉体验。

4.  **现代 UI**：它提供了一个现代化的用户界面，包括工作区、持久会话和通用历史记录，帮助用户保持组织和效率。

5.  **代码编辑**：Wave Terminal 提供了内联代码编辑功能，使用与 [Visual Studio Code](https://site.lovejade.cn/post/5af55777979f626ea3d37917) 相同的编辑器，这对于远程服务器上的代码编辑尤其有用。
...
── 出自[倾城之链 - Wave Terminal | An open-source, cross-platform terminal for seamless workflows](https://site.lovejade.cn/post/65bb7f998950812ce6932c7e)

## [Kimi Chat - 帮你看更大的世界](https://site.lovejade.cn/post/65b8ebae8950812ce693166b)
...
> 2.  **文件阅读**：用户可以上传文本文件（如 TXT、PDF、Word 文档、 [PPT](https://site.lovejade.cn/tags/PPT) 幻灯片、Excel 电子表格等），我可以阅读文件内容并根据内容回答问题。
...
总之，Kimi Chat 是国内 Moonshot AI 团队出品的类 Perplexity 产品，支持在回答问题之前，**先从搜索引擎爬取最新资讯，整合后再给出更精准有效的回答**，很大程度解决了大模型推理的幻觉问题，实用性很强；在日常工作中常用它（其他几款是 ChatGPT、 [素问智聊斋](https://chatgpt.nicelinks.site/) 、 [Poe](https://site.lovejade.cn/post/657b2f030ab15b034b64d8d7) ）。值得一提的是，它还支持将聊天文件导入到 Chat 中进行归纳总结，可谓非常方便。

── 出自[倾城之链 - Kimi Chat - 帮你看更大的世界](https://site.lovejade.cn/post/65b8ebae8950812ce693166b)

## [Vapor | The future of web development](https://site.lovejade.cn/post/65b8e2488950812ce69314c4)

**标签**：[`框架`](https://site.lovejade.cn/tags/框架) · [`Web开发`](https://site.lovejade.cn/tags/Web开发) · [`开源`](https://site.lovejade.cn/tags/开源)
...
**推荐语**：[Vapor](https://vapor.codes/) 是一个基于 [Swift](https://site.lovejade.cn/post/6232f5ca77e4352be838a308) 语言编写的开源 Web [框架](https://site.lovejade.cn/tags/框架) ，专为服务器端开发设计。它基于 Apple 的 SwiftNIO 库，这是一个非阻塞、事件驱动的网络框架。Vapor 的目标是让开发者能够使用 Swift 语言的强大功能来构建高性能的 Web 应用、API、 [HTTP](https://site.lovejade.cn/tags/HTTP) 服务器和后端服务。以下是 Vapor 的一些关键特性和优势：
...
── 出自[倾城之链 - Vapor | The future of web development](https://site.lovejade.cn/post/65b8e2488950812ce69314c4)

## [AI 红包封面生成器 ｜ AI Cover](https://site.lovejade.cn/post/65b88d398950812ce693105b)

**标签**：[`AI`](https://site.lovejade.cn/tags/AI) · [`微信`](https://site.lovejade.cn/tags/微信) · [`红包`](https://site.lovejade.cn/tags/红包)
...
**推荐语**：[AI 红包封面生成器](https://aicover.design/) ，是一款借助 [AI](https://site.lovejade.cn/tags/AI) 生成 [红包](https://site.lovejade.cn/tags/红包) 封面的在线工具，可以用来制作精美的红包封面（微信）。一般用于庆祝中国新年。顺便说一句，虽然说这是一款付费应用，但同时它也是一个开源项目：它基于 [NextJs](https://site.lovejade.cn/post/61c928af5be6454b4e3d5146) 全栈开发、 采用 [Tailwind CSS](https://site.lovejade.cn/post/5fd20cb4c06d6302c1907ec7) 编写前端 CSS 样式、supabase 来做数据存储，依赖 [Open AI dalle-3](https://site.lovejade.cn/post/6391e22878b7a1291995ff86) 处理图片生成， 采用 clerk 谷歌登录， aws s3 图片上传、 [Stripe](https://site.lovejade.cn/post/64524b8ac6f2367a83e85f7e) 付费支付....，如果您对该项目感兴趣， [可移步至 AI Cover 在 Github 开源仓库](https://github.com/all-in-aigc/aicover) ，从而了解更多。

── 出自[倾城之链 - AI 红包封面生成器 ｜ AI Cover](https://site.lovejade.cn/post/65b88d398950812ce693105b)

## [Microsoft Clarity - Free Heatmaps & Session Recordings](https://site.lovejade.cn/post/65b86e388950812ce6930e5f)

**标签**：[`数据分析`](https://site.lovejade.cn/tags/数据分析) · [`数据`](https://site.lovejade.cn/tags/数据) · [`分析`](https://site.lovejade.cn/tags/分析)
...
**推荐语**：[Clarity](https://clarity.microsoft.com/) 是一款由微软提供的免费工具，用于捕获用户使用网站。安装非常简单，可以在数分钟内开始获取 [数据](https://site.lovejade.cn/tags/数据) 。这样，你就能根据真正的用户行为来改进网站，让用户体验更好。而且，设置非常简单（与接入 Google Analytics 类似），永久免费（官方承诺：以绝对零成本享受 Clarity 的所有功能。永远不会遇到流量限制或被迫升级到付费版本）！Clarity 主要具有以下功能特征：
...
── 出自[倾城之链 - Microsoft Clarity - Free Heatmaps & Session Recordings](https://site.lovejade.cn/post/65b86e388950812ce6930e5f)

## [AI 工具集 | 700+ AI 工具集合官网，国内外 AI 工具集导航大全](https://site.lovejade.cn/post/65b7901b8950812ce6930a62)

**标签**：[`导航`](https://site.lovejade.cn/tags/导航) · [`AI`](https://site.lovejade.cn/tags/AI) · [`聚合`](https://site.lovejade.cn/tags/聚合)
...
**推荐语**：[AI 工具集](https://ai-bot.cn/) ：收录了国内外数百个 [AI](https://site.lovejade.cn/tags/AI) 工具，包括 AI 写作工具、AI 图像生成和背景移除、AI 视频制作、AI 音频转录、AI 辅助编程、AI 音乐生成、AI 绘画设计、AI 对话聊天等 AI 工具集合大全，以及 AI 学习开发的常用网站、框架和模型，帮助你加入人工智能浪潮，自动化高效完成任务！
...
── 出自[倾城之链 - AI 工具集 | 700+ AI 工具集合官网，国内外 AI 工具集导航大全](https://site.lovejade.cn/post/65b7901b8950812ce6930a62)

## [Moodist: Ambient Sounds for Focus and Calm](https://site.lovejade.cn/post/65b529a4c101ec2afe84ac3f)

**标签**：[`免费`](https://site.lovejade.cn/tags/免费) · [`噪音生成器`](https://site.lovejade.cn/tags/噪音生成器) · [`声音`](https://site.lovejade.cn/tags/声音)
...
**推荐语**：[Moodist](https://moodist.vercel.app/) 是一个 [免费](https://site.lovejade.cn/tags/免费) 的在线环境 [声音发生器](https://site.lovejade.cn/tags/噪音生成器) ，用于专注和平静，提供 35 种不同类别的精心挑选的声音，从大自然的宁静旋律到城市生活的舒缓氛围（包含自然、下雨、动物、城市、地点、运输等多类情境选择）。相比其他类似网站或应用，Moodist 支持制造多种特别的白噪音并叠加，还能调节噪音音量；在午休、看书或失眠的时候加入，应该很棒；值得说明的是，该项目在 [Github 仓库开源](https://github.com/geekyouth/moodist) ，并支持基于 [Docker](https://site.lovejade.cn/post/5b7036890f8719053c094d68) 自行部署。如果您对该项目获该网站该兴趣，不妨移步前往从而了解更多。

── 出自[倾城之链 - Moodist: Ambient Sounds for Focus and Calm](https://site.lovejade.cn/post/65b529a4c101ec2afe84ac3f)
