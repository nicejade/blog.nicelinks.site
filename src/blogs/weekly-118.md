...
## [GitHub Desktop | Simple collaboration from your desktop](https://site.lovejade.cn/post/6466338d52aed773d4811bb2)

**标签**：[`Github`](https://site.lovejade.cn/tags/Github) · [`Electron`](https://site.lovejade.cn/tags/Electron) · [`应用`](https://site.lovejade.cn/tags/应用)
...
**推荐语**：[GitHub Desktop](https://desktop.github.com/) ，一个开源的基于 [Electron](https://site.lovejade.cn/post/5b17d4a597006c5273505e1b) 的 GitHub 应用程序，它是用 [TypeScript](https://site.lovejade.cn/post/6278fdeaac00ce3f9b11a8ef) 编写的，并使用 [React](https://site.lovejade.cn/post/5b1294b5e93ed2618cfac134) 。它让您专注于重要的事情，而不是与 Git 争吵。无论您是 Git 新手还是经验丰富的用户，GitHub Desktop 都能简化您的开发工作流程。

借助 [GitHub](https://site.lovejade.cn/tags/GitHub) Desktop，您可以使用 GUI 而不是 [命令行](https://site.lovejade.cn/tags/命令行) 或 Web 浏览器与 GitHub 交互。您可以使用 GitHub Desktop 从您的桌面完成大多数 [Git](https://site.lovejade.cn/tags/Git) 命令，例如推送到远程存储库、从远程存储库拉取和克隆远程存储库、归属提交和创建拉取请求，并通过视觉确认更改。该项目在也 [Github 开源](https://github.com/desktop/desktop)，如果您对其感兴趣，可移步前往以了解更多。

── 出自[倾城之链 - GitHub Desktop | Simple collaboration from your desktop](https://site.lovejade.cn/post/6466338d52aed773d4811bb2)

## [Gifdeas AI ｜ The free AI powered tool that helps you to get the perfect gift](https://site.lovejade.cn/post/646629be52aed773d4811a97)

**标签**：[`AI`](https://site.lovejade.cn/tags/AI) · [`免费`](https://site.lovejade.cn/tags/免费) · [`灵感`](https://site.lovejade.cn/tags/灵感)
...
**推荐语**：[Gifdeas AI](https://giftdeas.app/) ，礼品赠送人工智能工具，帮助您挑选完美的礼物提供 [灵感](https://site.lovejade.cn/tags/灵感) ，完全免费；该产品采用最新的 [AI](https://site.lovejade.cn/tags/AI) 模型，旨在了解您的朋友、伴侣或家人的喜好，并根据他们的年龄和兴趣提出建议，让您轻松找到理想的礼物。对于难以找到合适的礼物，或希望确保他们的礼物符合收礼人的喜好的个人来说，这是一个很好的解决方案。该产品利用人工智能技术这一事实，为流程增加了额外的 [效率](https://site.lovejade.cn/tags/效率) 和准确性。
...
── 出自[倾城之链 - Gifdeas AI ｜ The free AI powered tool that helps you to get the perfect gift](https://site.lovejade.cn/post/646629be52aed773d4811a97)

## [Dify - LLMOps platform, Define your AI-native apps](https://site.lovejade.cn/post/64660fdd52aed773d4811936)

**标签**：[`平台`](https://site.lovejade.cn/tags/平台) · [`AI`](https://site.lovejade.cn/tags/AI) · [`可视化`](https://site.lovejade.cn/tags/可视化)
...
**推荐语**：[Dify](https://dify.ai/) 是一款开源且易用的 LLMOps 平台，简单地创建和操作，基于 GPT-4 的 AI 原生应用；旨在帮助开发者更简单、更快速地构建 [AI](https://site.lovejade.cn/tags/AI) 应用。它提供了可视化的 [Prompt](https://site.lovejade.cn/tags/Prompt) 编排、运营、数据集管理等功能，可以让用户在几分钟内创建一个 AI 应用，或将 LLM 快速集成到现有应用中，进行持续运营和改进，创造一个真正有价值的 AI 应用。
...
以[文档](https://site.lovejade.cn/tags/文档) / 网页 / [Notion](https://site.lovejade.cn/tags/Notion) 内容作为 AI 的语境，自动完成文本预处理、矢量化和分割。您不必再学习嵌入技术，从而节省数周的开发时间。
...
Dify 提供了多种类型应用的可视化编排，应用可开箱即用，也能以 "后端即服务" 的 [API](https://site.lovejade.cn/tags/API) 提供服务。使用用于插件和数据集集成的一个 API 统一您的开发流程，并使用用于快速工程、可视化分析和持续改进的单一界面简化您的操作。此外，Dify 还提供了丰富的文档和下载资源，方便用户进行学习和使用。

── 出自[倾城之链 - Dify - LLMOps platform, Define your AI-native apps](https://site.lovejade.cn/post/64660fdd52aed773d4811936)

## [KeepingYouAwake: Prevents your Mac from going to sleep](https://site.lovejade.cn/post/6465cfc552aed773d481154a)

**标签**：[`Mac`](https://site.lovejade.cn/tags/Mac) · [`应用`](https://site.lovejade.cn/tags/应用) · [`开源`](https://site.lovejade.cn/tags/开源)
...
**推荐语**：[KeepingYouAwake](https://keepingyouawake.app/) ，是适用于 [MacOS](https://site.lovejade.cn/tags/Mac) （版本 10.13 及更新版本）的小型菜单栏实用程序，可以防止您的 Mac 在预定义的持续时间内或只要它处于激活状态就进入睡眠模式。它具有如下功能特征：
...
此实用程序不会损害您的 Mac，因为它基于 [Apple](https://site.lovejade.cn/post/5a6dded27573725434e7e79a) 的官方 [命令行](https://site.lovejade.cn/tags/命令行) 工具。**但**作者不能保证任何事情，所以使用这个工具**需要您自担风险**。
...
── 出自[倾城之链 - KeepingYouAwake: Prevents your Mac from going to sleep](https://site.lovejade.cn/post/6465cfc552aed773d481154a)

## [Orillusion | 专业 WebGPU 引擎](https://site.lovejade.cn/post/6465a1a752aed773d481128a)

**标签**：[`引擎`](https://site.lovejade.cn/tags/引擎) · [`WebGPU`](https://site.lovejade.cn/tags/WebGPU) · [`3D`](https://site.lovejade.cn/tags/3D)
...
**推荐语**：[Orillusion](https://www.orillusion.com/) 是一款完全基于 [WebGPU](https://site.lovejade.cn/tags/WebGPU) 标准开发的纯 Web3D 渲染引擎；简单易用，功能强大，为 Web3D 提供完善开发工具。旨在实现桌面级渲染效果，支持在浏览器中对复杂场景进行 3D 渲染。它具有如下功能特征：
...
── 出自[倾城之链 - Orillusion | 专业 WebGPU 引擎](https://site.lovejade.cn/post/6465a1a752aed773d481128a)

## [Marked Documentation](https://site.lovejade.cn/post/6464df7352aed773d4810caf)

**标签**：[`Markdown`](https://site.lovejade.cn/tags/Markdown) · [`文档`](https://site.lovejade.cn/tags/文档) · [`JavaScript`](https://site.lovejade.cn/tags/JavaScript)
...
**推荐语**：[Marked.js](https://marked.js.org/) ， [Markdown](https://site.lovejade.cn/tags/Markdown) 解析器和编译器，专为速度而生。它具有以下功能特征：

- ⬇️ 用于解析 [Markdown](https://site.lovejade.cn/tags/Markdown) 的低级编译器，无需长时间缓存或阻塞；
- ⚖️ 轻量级，同时实现支持的风格和规格的所有 [Markdown](https://site.lovejade.cn/tags/Markdown) 功能；
- 🌐 在浏览器、服务器或 [命令行](https://site.lovejade.cn/tags/命令行) 界面 (CLI) 中工作；
...
[Markdown](https://site.lovejade.cn/tags/Markdown) 是一种轻量级的「**标记语言**」，它允许人们使用易读易写的纯文本格式编写文档，然后转换成有效的 XHTML（或者 HTML）文档。目前它被越来越多的写作爱好者，撰稿者广泛使用。譬如 [ChatGPT](https://site.lovejade.cn/tags/ChatGPT) 所返回的结果就是 Markdown 格式，而 `marked` 的作用在于将 `markdown` 转化成 HTML，从而渲染到页面，不仅可作用于浏览器（可跟任何框架结合）、Node.js，也能在命令行使用。

── 出自[倾城之链 - Marked Documentation](https://site.lovejade.cn/post/6464df7352aed773d4810caf)

## [Wormhole - Simple, private file sharing](https://site.lovejade.cn/post/6464bc7052aed773d4810a3f)

**标签**：[`文件传输`](https://site.lovejade.cn/tags/文件传输) · [`分享`](https://site.lovejade.cn/tags/分享) · [`在线`](https://site.lovejade.cn/tags/在线)
...
── 出自[倾城之链 - Wormhole - Simple, private file sharing](https://site.lovejade.cn/post/6464bc7052aed773d4810a3f)

## [Phosphor Icons](https://site.lovejade.cn/post/6463684752aed773d481011f)

**标签**：[`图标`](https://site.lovejade.cn/tags/图标) · [`SVG`](https://site.lovejade.cn/tags/SVG) · [`程序库`](https://site.lovejade.cn/tags/程序库)
...
── 出自[倾城之链 - Phosphor Icons](https://site.lovejade.cn/post/6463684752aed773d481011f)

## [ChatGPT Next Web](https://site.lovejade.cn/post/64634acb52aed773d4810004)

**标签**：[`ChatGPT`](https://site.lovejade.cn/tags/ChatGPT) · [`自托管`](https://site.lovejade.cn/tags/自托管) · [`开源`](https://site.lovejade.cn/tags/开源)
...
**推荐语**：[ChatGPT Next Web](https://chatgpt.nextweb.fun/) ，一款开源项目，支持一键免费部署你的私人 [ChatGPT](https://site.lovejade.cn/tags/ChatGPT) 网页应用，基于 [Next.js](https://site.lovejade.cn/post/61c928af5be6454b4e3d5146) 、 [React](https://site.lovejade.cn/post/5b1294b5e93ed2618cfac134) 所搭建。它具有以下**功能特征**：

- 在 1 分钟内使用 [Vercel](https://site.lovejade.cn/post/63dba9f93b0bd5224de21d36) **免费一键部署**；
- 完整的 [Markdown](https://site.lovejade.cn/tags/Markdown) 支持：LaTex 公式、Mermaid 流程图、代码高亮等等；
- 精心设计的 UI，响应式设计，支持深色模式，支持 [PWA](https://site.lovejade.cn/tags/PWA)；
...
── 出自[倾城之链 - ChatGPT Next Web](https://site.lovejade.cn/post/64634acb52aed773d4810004)

## [Fingerprint Pro - Formerly FingerprintJS - Device fingerprinting API](https://site.lovejade.cn/post/64625dd252aed773d480f8fd)
...
── 出自[倾城之链 - Fingerprint Pro - Formerly FingerprintJS - Device fingerprinting API](https://site.lovejade.cn/post/64625dd252aed773d480f8fd)

## [Pixelcut – AI Product Photos – Free Design Tool](https://site.lovejade.cn/post/64609b7452aed773d480ee2a)

**标签**：[`设计`](https://site.lovejade.cn/tags/设计) · [`AI`](https://site.lovejade.cn/tags/AI) · [`图片`](https://site.lovejade.cn/tags/图片)
...
**推荐语**：[Pixelcut.AI](https://www.pixelcut.ai/) 是一个免费的在线 [设计](https://site.lovejade.cn/tags/设计) 工具，可以轻松地为您的网店制作产品照片、广告等。轻松地从图像中删除背景或橡皮擦对象。该产品使用 AI 将创建精美的产品照片的速度提高 10 倍，而且使用体验就像拍照一样简单。使用手机上的 AI 驱动的编辑工具，您可以快速轻松地编辑您的照片以达到完美效果。

── 出自[倾城之链 - Pixelcut – AI Product Photos – Free Design Tool](https://site.lovejade.cn/post/64609b7452aed773d480ee2a)

## [Chains - The Ultimate Multichain Launchpad and Cryptocurrency Platform](https://site.lovejade.cn/post/6460934052aed773d480edc6)

**标签**：[`平台`](https://site.lovejade.cn/tags/平台) · [`区块链`](https://site.lovejade.cn/tags/区块链) · [`Web3`](https://site.lovejade.cn/tags/Web3)
...
[Web3](https://site.lovejade.cn/tags/Web3) 的核心理念就是以用户为中心，它要在将中心化世界里由巨头掌控的权力还给个人用户，这意味着需要吸引更多的用户并扩大影响力。然而 Web3 的准入门槛太高了，对大众用户来说，加入 Web3 是一个复杂且常常令人挫败的过程。
...
── 出自[倾城之链 - Chains - The Ultimate Multichain Launchpad and Cryptocurrency Platform](https://site.lovejade.cn/post/6460934052aed773d480edc6)
