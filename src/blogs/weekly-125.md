...
## [Threads - Instagram's text-based conversation app](https://site.lovejade.cn/post/64a690a43cd8f526b6edbe3d)

**标签**：[`应用`](https://site.lovejade.cn/tags/应用) · [`社区`](https://site.lovejade.cn/tags/社区) · [`分享`](https://site.lovejade.cn/tags/分享)
...
── 出自[倾城之链 - Threads - Instagram's text-based conversation app](https://site.lovejade.cn/post/64a690a43cd8f526b6edbe3d)

## [Welcome · magic-regexp](https://site.lovejade.cn/post/64a2c26d3cd8f526b6eda707)

**标签**：[`TypeScript`](https://site.lovejade.cn/tags/TypeScript) · [`正则`](https://site.lovejade.cn/tags/正则) · [`开源`](https://site.lovejade.cn/tags/开源)
...
── 出自[倾城之链 - Welcome · magic-regexp](https://site.lovejade.cn/post/64a2c26d3cd8f526b6eda707)

## [Orama - Search, everywhere.](https://site.lovejade.cn/post/64a1a4773cd8f526b6eda074)
...
**推荐语**：[Orama](https://oramasearch.com/) 是一个快速、内置电池的全文 [搜索](https://site.lovejade.cn/tags/搜索) 引擎，完全用 [TypeScript](https://site.lovejade.cn/tags/TypeScript) 编写，零依赖性。它具有弹性、创新和 [开源](https://site.lovejade.cn/tags/开源) 的搜索体验，以实现与您的基础设施和数据无缝整合。
...
── 出自[倾城之链 - Orama - Search, everywhere.](https://site.lovejade.cn/post/64a1a4773cd8f526b6eda074)

## [Markmap | Visualize your Markdown as mindmaps](https://site.lovejade.cn/post/64a157543cd8f526b6ed9d68)

**标签**：[`思维导图`](https://site.lovejade.cn/tags/思维导图) · [`可视化`](https://site.lovejade.cn/tags/可视化) · [`Markdown`](https://site.lovejade.cn/tags/Markdown)
...
**推荐语**：[Markmap](https://markmap.js.org/) ，是一个开源 [程序库](https://site.lovejade.cn/tags/程序库) ，使用 [Markmap](https://site.lovejade.cn/tags/Markmap) 将 Markdown [可视化](https://site.lovejade.cn/tags/可视化) 为思维导图。Markmap 是 Markdown 和 [思维导图](https://site.lovejade.cn/tags/思维导图) 的组合。它解析 Markdown 内容并提取其内在的层次结构并呈现交互式思维导图，又称**标记图**（`markmap`）。
...
基本原理，Markmap 使用 markmap-lib 将 Markdown 预处理为结构化数据，然后使用 markmap-view 将数据渲染为交互式 [SVG](https://site.lovejade.cn/tags/SVG) 。值得一提的是，该项目在 [Github 仓库开源](https://github.com/markmap/markmap) ，如果您对其感兴趣，可移步以了解更多。

── 出自[倾城之链 - Markmap | Visualize your Markdown as mindmaps](https://site.lovejade.cn/post/64a157543cd8f526b6ed9d68)

## [MRSK — Deploy web apps anywhere](https://site.lovejade.cn/post/64a153ea3cd8f526b6ed9d32)

**标签**：[`Docker`](https://site.lovejade.cn/tags/Docker) · [`云服务`](https://site.lovejade.cn/tags/云服务) · [`运维`](https://site.lovejade.cn/tags/运维)
...
**推荐语**：[MRSK](https://mrsk.dev/) 使用 [Docker](https://site.lovejade.cn/post/5b7036890f8719053c094d68) 在从裸机到云虚拟机的任何地方部署 Web 应用程序，且停机时间为零。它使用**动态反向代理** Traefik 在新应用程序容器启动和旧应用程序容器停止时保存请求。它可以跨多个主机无缝工作，使用 SSHKit 执行命令。它是为 Rails 应用程序构建的，但适用于可以使用 Docker 进行容器化的任何类型的 Web 应用程序。

在过去的十多年里，商业产品呈爆炸式增长，使 Web 应用程序的部署变得更加容易。 [Heroku](https://www.heroku.com/) 以令人难以置信的产品拉开了序幕，该产品似乎永远在竞争中保持领先地位。如今，有了 Fly.io 和 Render 等优秀的替代品。托管 [Kubernetes](https://site.lovejade.cn/post/5b2cad0a34c03342fda0f37e) 也让 AWS、GCP、 [Digital Ocean](https://site.lovejade.cn/post/5b0ea574e93ed2618cfac12d) 和其他地方的事情变得更加容易。但这些产品都可以让您以高价租用云中的计算机。如果您想在自己的硬件上运行，或者只是将来有一个明确的迁移路径，您需要仔细考虑如何锁定这些商业平台。最好是在账单吞没你的整个生意之前！
...
最终，MRSK 旨在使用不依赖于任何商业产品的开源工具来压缩投入生产的复杂性。请注意，不是为零。如果基本的 [Linux](https://site.lovejade.cn/tags/Linux) 或 Docker 仍然很困难，那么使用完全托管的服务可能会更好，但一旦熟悉了这些概念，您就可以准备使用 MRSK。值得一提的是，该项目在 [Github 仓库开源](https://github.com/mrsked/mrsk) ，如果您对其感兴趣，可移步以了解更多。

── 出自[倾城之链 - MRSK — Deploy web apps anywhere](https://site.lovejade.cn/post/64a153ea3cd8f526b6ed9d32)
