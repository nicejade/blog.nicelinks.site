...
**标签**：[`社区`](https://site.lovejade.cn/tags/社区) · [`论坛`](https://site.lovejade.cn/tags/论坛) · [`分享`](https://site.lovejade.cn/tags/分享)
...
**推荐语**：[悠然宜想亭](https://forum.lovejade.cn/)是基于 [Flarum](https://site.lovejade.cn/post/604795465f9af714fe21dcbc) 所搭建的现代化社区，旨在营造温润、宽厚、互助的分享环境，也为互联网开放性做些努力；其内容以「经世济用」、有趣、有价值为主调。关于[悠然宜想亭](https://forum.lovejade.cn/)，您如果想知道更多，可参阅如下几篇文章：

- [关于“悠然宜想亭”的由来，以及未来](https://forum.lovejade.cn/d/1)；
- [悠然宜想亭，各 Tag 的设定说明](https://forum.lovejade.cn/d/8-tag)；

── 出自[倾城之链 - 悠然宜想亭](https://site.lovejade.cn/post/60535e3306342c4b00e04ece)

## [Gitpod - Dev environments built for the cloud](https://www.gitpod.io/?utm_source=nicelinks.site)

**标签**：[`开发者`](https://site.lovejade.cn/tags/开发者) · [`Github`](https://site.lovejade.cn/tags/Github) · [`编辑器`](https://site.lovejade.cn/tags/编辑器)
...
**推荐语**：[Gitpod](https://www.gitpod.io/) 通过在浏览器中提供由 [VS Code](https://site.lovejade.cn/post/5af55777979f626ea3d37917) 提供的预建协作开发环境，简化了开发者的工作流程。Gitpod 具有以下功能特性：
...
- **正确执行 Cloud Native 开发**：完全在云上编码，构建，调试和运行 [K8s](https://site.lovejade.cn/post/5b2cad0a34c03342fda0f37e)（Kubernetes） 应用程序。为每个分支获取成熟的工作区并提取/合并请求，这些请求已预先配置并预先连接到自己的专用 K8s 部署。
...
── 出自[倾城之链 - Gitpod - Dev environments built for the cloud](https://site.lovejade.cn/post/60534abf06342c4b00e04ecc)

## [Defonic | A fabulous ambient noise generator](https://defonic.com/?utm_source=nicelinks.site)

**标签**：[`应用`](https://site.lovejade.cn/tags/应用) · [`噪音生成器`](https://site.lovejade.cn/tags/噪音生成器) · [`声音`](https://site.lovejade.cn/tags/声音)
...
── 出自[倾城之链 - Defonic | A fabulous ambient noise generator](https://site.lovejade.cn/post/605336f606342c4b00e04eca)
...
── 出自[倾城之链 - Rainbow Hunt | Ultimate rain generator for relaxing or working](https://site.lovejade.cn/post/605323bd06342c4b00e04ec8)

## [卜卜口](https://mouto.org/?utm_source=nicelinks.site)

**标签**：[`前端开发`](https://site.lovejade.cn/tags/前端开发) · [`摄影`](https://site.lovejade.cn/tags/摄影) · [`程序员`](https://site.lovejade.cn/tags/程序员)
...
── 出自[倾城之链 - 卜卜口](https://site.lovejade.cn/post/6052afa406342c4b00e04ec5)

## [Coder: The Developer Workspace Platform](https://coder.com/?utm_source=nicelinks.site)

**标签**：[`程序员`](https://site.lovejade.cn/tags/程序员) · [`开发者`](https://site.lovejade.cn/tags/开发者) · [`编码`](https://site.lovejade.cn/tags/编码)
...
值得一提的是，[Coder](https://coder.com/) 还开源了 [cdr/code-server](https://github.com/cdr/code-server)（VS Code in the browser）项目，它允许开发人员使用浏览器访问运行 [VS Code](https://site.lovejade.cn/post/5af55777979f626ea3d37917) 的远程开发环境。[Coder](https://coder.com/) 以 [cdr/code-server](https://github.com/cdr/code-server) 的成功为基础，并增加了为企业团队设计的功能，包括对其他 [IDE](https://site.lovejade.cn/tags/IDE) 的支持和高级安全功能。

── 出自[倾城之链 - Coder: The Developer Workspace Platform](https://site.lovejade.cn/post/6051fe0706342c4b00e04ec3)

## [Embed.so - Make your website more personal and engaging](https://embed.so/?utm_source=nicelinks.site)

**标签**：[`视频`](https://site.lovejade.cn/tags/视频) · [`网站`](https://site.lovejade.cn/tags/网站) · [`工具`](https://site.lovejade.cn/tags/工具)
...
── 出自[倾城之链 - Embed.so - Make your website more personal and engaging](https://site.lovejade.cn/post/6051e83c06342c4b00e04ec1)
