...
## [Markdown for the component era | MDX](https://site.lovejade.cn/post/63e4e3eee63ccd089dee6686)

**标签**：[`Markdown`](https://site.lovejade.cn/tags/Markdown) · [`Web开发`](https://site.lovejade.cn/tags/Web开发) · [`component`](https://site.lovejade.cn/tags/component)
...
**推荐语**：[MDX](https://mdxjs.com/) ，**组件时代**的 [Markdown](https://site.lovejade.cn/tags/Markdown)，允许你在 markdown 内容中使用 JSX。您可以导入组件，例如交互式图表或警报，并将它们嵌入到您的内容中。这使得使用组件编写长篇内容成为一种乐趣。经过多年的努力，MDX 的第 2 版发布了，并且有很多改进。以下是亮点：
...
── 出自[倾城之链 - Markdown for the component era | MDX](https://site.lovejade.cn/post/63e4e3eee63ccd089dee6686)

## [Nextra – Next.js Static Site Generator](https://site.lovejade.cn/post/63e4db7ee63ccd089dee6599)

**标签**：[`React`](https://site.lovejade.cn/tags/React) · [`框架`](https://site.lovejade.cn/tags/框架) · [`网站生成器`](https://site.lovejade.cn/tags/网站生成器)
...
**推荐语**：[Nextra](https://nextra.site/) ，基于 [Next.js](https://site.lovejade.cn/post/61c928af5be6454b4e3d5146) （ [React](https://site.lovejade.cn/post/5b1294b5e93ed2618cfac134) ） 和 [MDX](https://site.lovejade.cn/post/63e4e3eee63ccd089dee6686) 的静态网站生成器，可制作漂亮的网站；它简单、强大和灵活的站点生成框架，包含您喜欢的 Next.js 的一切。Next.js，一个用于 生产环境的 React 框架，为您提供生产所需的所有功能的最佳开发人员体验：混合静态和服务器渲染、TypeScript 支持、智能捆绑、路由预取等。无需配置。

[Nextra](https://nextra.site/) 在 Next.js 基础上再封装，引入 [pnpm](https://site.lovejade.cn/post/62989af00f40a860b1599de2)、[Tailwind CSS](https://site.lovejade.cn/post/5fd20cb4c06d6302c1907ec7)、[MDX](https://site.lovejade.cn/post/63e4e3eee63ccd089dee6686)、[flexsearch](https://github.com/nextapps-de/flexsearch)、[Turbo](https://site.lovejade.cn/post/635936a6775cbe1cdc6eb333)、[Shiki](https://shiki.matsu.io/)（漂亮的语法高亮库）等，使得开发更加高效、便捷，而且对链接、图片、全文搜索、暗黑主题、多语言等做了优化，开箱即用。如果您有基于 React 搭建网站的诉求，推荐 [Nextra](https://nextra.site/) 进入您首选考虑范畴。

── 出自[倾城之链 - Nextra – Next.js Static Site Generator](https://site.lovejade.cn/post/63e4db7ee63ccd089dee6599)

## [Moby Project - a collaborative project for the container ecosystem to assemble container-based systems](https://site.lovejade.cn/post/63e3a8afe7eec03b5eacebff)

**标签**：[`Docker`](https://site.lovejade.cn/tags/Docker) · [`开源`](https://site.lovejade.cn/tags/开源) · [`容器`](https://site.lovejade.cn/tags/容器)
...
**推荐语**：[Moby](https://mobyproject.org/) ，是 [Docker](https://site.lovejade.cn/tags/Docker) 创建的一个开放框架，用于组装专门的容器系统，而无需重新发明轮子。它提供了一个由数十个标准组件组成的“乐高集”，以及一个将它们组装到定制平台的框架。Moby 的核心是一个用于组装专用容器系统的框架，它提供：
...
── 出自[倾城之链 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems](https://site.lovejade.cn/post/63e3a8afe7eec03b5eacebff)

## [Rectangle Mac](https://site.lovejade.cn/post/63e393dce7eec03b5eaceb34)

**标签**：[`Mac`](https://site.lovejade.cn/tags/Mac) · [`应用`](https://site.lovejade.cn/tags/应用) · [`免费`](https://site.lovejade.cn/tags/免费)
...
── 出自[倾城之链 - Rectangle Mac](https://site.lovejade.cn/post/63e393dce7eec03b5eaceb34)

## [Frond - A better way to build community online](https://site.lovejade.cn/post/63e251895769b373841a6065)

**标签**：[`平台`](https://site.lovejade.cn/tags/平台) · [`在线`](https://site.lovejade.cn/tags/在线) · [`社区`](https://site.lovejade.cn/tags/社区)
...
- **项目**：一个集思广益、设定目标、回答问题和相互了解的地方。链接你的 [Github](https://site.lovejade.cn/tags/) ，它就可以开始了。
...
── 出自[倾城之链 - Frond - A better way to build community online](https://site.lovejade.cn/post/63e251895769b373841a6065)

## [Open-Source UI elements - made with CSS and HTML](https://site.lovejade.cn/post/63e23bda5769b373841a5fa0)

**标签**：[`HTML`](https://site.lovejade.cn/tags/HTML) · [`CSS`](https://site.lovejade.cn/tags/CSS) · [`Web开发`](https://site.lovejade.cn/tags/Web开发)
...
**推荐语**：[uiverse.io](https://uiverse.io/) ，免费和可定制的 [HTML](https://site.lovejade.cn/tags/HTML) 和 [CSS](https://site.lovejade.cn/tags/CSS) UI 元素库，让您的网站更独特。涉及元素颇为丰富，涵盖卡片、开关、输入框、复选框 ☑️、加载动画、按钮（Button）等，使用非常简单，复制粘贴即可。它完全是开源的，免费供给个人和商业使用，可以给你的项目增加一些有趣的元素，为你的下一个项目节省许多花在构建和定制 UI 组件上的时间。

── 出自[倾城之链 - Open-Source UI elements - made with CSS and HTML](https://site.lovejade.cn/post/63e23bda5769b373841a5fa0)

## [Godot Engine - Free and open source 2D and 3D game engine](https://site.lovejade.cn/post/63e0ffe75769b373841a5526)

**标签**：[`游戏`](https://site.lovejade.cn/tags/游戏) · [`引擎`](https://site.lovejade.cn/tags/引擎) · [`3D`](https://site.lovejade.cn/tags/3D)
...
Godot 最初于 2007 年开始开发，2014 年 12 月 15 日，Godot 迎来了首个稳定版本 1.0；2016 年 2 月 24 日上架 Steam；2023 年 2 月，Godot 4.0 版本发布。从宏观上看，Godot 与 [Unity](https://site.lovejade.cn/post/60f8020181b2dc066ea4bd73)、Unreal 尚有差距，但颇受开发者好评，如果您对其感兴趣，不妨前往官网了解更多。

── 出自[倾城之链 - Godot Engine - Free and open source 2D and 3D game engine](https://site.lovejade.cn/post/63e0ffe75769b373841a5526)

## [Cocos - The world's top 2D&3D engine, game / smart cockpit /AR/VR/ virtual character / education](https://site.lovejade.cn/post/63e0f4695769b373841a54aa)
...
── 出自[倾城之链 - Cocos - The world's top 2D&3D engine, game / smart cockpit /AR/VR/ virtual character / education](https://site.lovejade.cn/post/63e0f4695769b373841a54aa)
