...
## [Auto-GPT | An experimental open-source attempt to make GPT-4 fully autonomous](https://site.lovejade.cn/post/6453ac5fc6f2367a83e8699f)

**标签**：[`自动化`](https://site.lovejade.cn/tags/自动化) · [`ChatGPT`](https://site.lovejade.cn/tags/ChatGPT) · [`开源`](https://site.lovejade.cn/tags/开源)
...
**推荐语**：[Auto-GPT](https://github.com/Significant-Gravitas/Auto-GPT) 是一个实验性 [开源](https://site.lovejade.cn/tags/开源) 应用程序，展示了 GPT-4 语言模型的功能。该程序由 GPT-4 驱动，将 LLM（Large Language Model：大语言模型） 的“思想”链接在一起，以自主实现您设定的任何目标。作为 GPT-4 完全自主运行的首批示例之一，Auto-GPT 突破了 [AI](https://site.lovejade.cn/tags/AI) 的可能性界限。官方描述它具有以下特征：
...
── 出自[倾城之链 - Auto-GPT | An experimental open-source attempt to make GPT-4 fully autonomous](https://site.lovejade.cn/post/6453ac5fc6f2367a83e8699f)

## [Taxonomy | 使用 Next.js 13 服务器组件构建的示例应用程序](https://site.lovejade.cn/post/64537466c6f2367a83e86861)

**标签**：[`React`](https://site.lovejade.cn/tags/React) · [`Tailwind`](https://site.lovejade.cn/tags/Tailwind) · [`开源`](https://site.lovejade.cn/tags/开源)
...
**推荐语**：[Taxonomy](https://tx.shadcn.com/) ，使用 [Next.js](https://site.lovejade.cn/post/61c928af5be6454b4e3d5146) 13 服务器组件构建的示例应用程序，该项目是一个实验，旨在了解具有身份验证、订阅、API 路由和静态页面等功能的现代应用程序如何在 Next.js 13 应用程序目录中工作。它具有以下特征：

- Next.js 13：应用程序目录、路由、布局、加载 UI 和 API 路由。
- [React](https://site.lovejade.cn/post/5b1294b5e93ed2618cfac134) 18：服务器和客户端组件。使用挂钩。
- 数据库：ORM 使用 [Prisma](https://site.lovejade.cn/post/64531bfdc6f2367a83e863ff) 并部署在 PlanetScale 上。
- 成分：使用 Radix UI 构建并使用 [Tailwind CSS](https://site.lovejade.cn/post/5fd20cb4c06d6302c1907ec7) 设置样式的 UI 组件。
- 验证：使用 NextAuth.js 和中间件进行身份验证。
- 订阅：使用 [Stripe](https://site.lovejade.cn/post/64524b8ac6f2367a83e85f7e) 进行免费和付费订阅。

Taxonomy 还包括一个博客和一个使用 [Contentlayer](https://www.contentlayer.dev/) 和 [MDX](https://site.lovejade.cn/post/63e4e3eee63ccd089dee6686) 构建的全功能文档站点。该项目目前尚在建设中，如果您对其感兴趣，可移步至 [Github 开源仓库](https://github.com/shadcn/taxonomy) ，以了解更多。

── 出自[倾城之链 - Taxonomy | 使用 Next.js 13 服务器组件构建的示例应用程序](https://site.lovejade.cn/post/64537466c6f2367a83e86861)

## [Free Online Form Builder | Tally](https://site.lovejade.cn/post/645364ffc6f2367a83e86778)

**标签**：[`问卷调查`](https://site.lovejade.cn/tags/问卷调查) · [`免费`](https://site.lovejade.cn/tags/免费) · [`在线`](https://site.lovejade.cn/tags/在线)
...
── 出自[倾城之链 - Free Online Form Builder | Tally](https://site.lovejade.cn/post/645364ffc6f2367a83e86778)

## [DeepLearning.AI: Start or Advance Your Career in AI](https://site.lovejade.cn/post/64535c9ac6f2367a83e866bc)

**标签**：[`教育`](https://site.lovejade.cn/tags/教育) · [`AI`](https://site.lovejade.cn/tags/AI) · [`学习`](https://site.lovejade.cn/tags/学习)
...
**推荐语**：[DeepLearning.AI](https://www.deeplearning.ai/) 是一家教育技术公司，通过世界一流的教育、实践培训和协作社区，让全球员工能够构建人工智能驱动的未来。该品牌由 [机器学习](https://site.lovejade.cn/tags/机器学习) 和教育先驱吴恩达于 2017 年创立，旨在满足世界级人工智能教育的需求。

DeepLearning.AI 在 Coursera 上创建了高质量的 [人工智能](https://site.lovejade.cn/tags/AI) 程序，在全球范围内获得了广泛的关注。通过提供教育平台和培养紧密联系的社区，DeepLearning.AI 已成为任何希望从事 AI 职业的人的途径。
...
── 出自[倾城之链 - DeepLearning.AI: Start or Advance Your Career in AI](https://site.lovejade.cn/post/64535c9ac6f2367a83e866bc)

## [Prisma | Next-generation ORM for Node.js & TypeScript](https://site.lovejade.cn/post/64531bfdc6f2367a83e863ff)

**标签**：[`数据库`](https://site.lovejade.cn/tags/数据库) · [`TypeScript`](https://site.lovejade.cn/tags/TypeScript) · [`开源`](https://site.lovejade.cn/tags/开源)
...
ORM (Object/Relational Mapping)，简单的来说就是一个可以像操作对象一样操作数据库的工具；介绍可以参看 [@阮一峰](https://site.lovejade.cn/post/59be8365f4aed63e37a280af) 所写的 [《ORM 实例教程》](http://www.ruanyifeng.com/blog/2019/02/orm-tutorial.html) ； [mongoose](https://github.com/Automattic/mongoose) 、 [typegoose](https://github.com/typegoose/typegoose) 可看作是 [MongoDB](https://site.lovejade.cn/post/62692add77f8270876fcb3dc) 专用的 ORM。以下是 [ChatGPT](https://site.lovejade.cn/tags/ChatGPT) 给出的关于 `prisma` 的介绍：
...
── 出自[倾城之链 - Prisma | Next-generation ORM for Node.js & TypeScript](https://site.lovejade.cn/post/64531bfdc6f2367a83e863ff)

## [AItoolkit - The best AI Tools & Resources Directory](https://site.lovejade.cn/post/64531370c6f2367a83e86338)
...
**推荐语**：[AI Tools](https://www.aitoolkit.org/) ，人工智能（ [AI](https://site.lovejade.cn/tags/AI) ）工具导航网站：一个精心策划的顶级人工智能工具和资源目录，旨在帮助你简化流程，提高生产力，并推动创新。目前已经汇聚 1400 多个 AI 工具，您可以简单向下滚动查看，也可以通过网站提供的过滤器筛选类别（诸如：图像改善、营销、灵感、文案、翻译、头像、生成代码、动作捕捉、聊天、播客、生成视频、文字转视频等等）；此外， [AI Tools](https://www.aitoolkit.org/) 有根据网站的付费模型做了区分（免费、免费增值、付费），使得用户可以更快找到匹配工具。该网站目前尚在积极更新迭代中，如果您对其感兴趣，可移步 [AI Tools 推特](https://twitter.com/ai_toolkit) 以了解更多。

── 出自[倾城之链 - AItoolkit - The best AI Tools & Resources Directory](https://site.lovejade.cn/post/64531370c6f2367a83e86338)

## [Stripe | Payment Processing Platform for the Internet](https://site.lovejade.cn/post/64524b8ac6f2367a83e85f7e)

**标签**：[`产品`](https://site.lovejade.cn/tags/产品) · [`支付`](https://site.lovejade.cn/tags/支付) · [`平台`](https://site.lovejade.cn/tags/平台)
...
── 出自[倾城之链 - Stripe | Payment Processing Platform for the Internet](https://site.lovejade.cn/post/64524b8ac6f2367a83e85f7e)
